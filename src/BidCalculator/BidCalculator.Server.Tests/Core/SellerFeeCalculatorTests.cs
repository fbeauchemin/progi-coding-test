...
public class SellerFeeCalculatorTests
{
	public class CalculateMethod
	{
		...
		public void Returns_2_Percent_Of_BasePrice_ForCommonType(double basePrice, double amount)
		{
		...
		public void Returns_4_Percent_Of_BasePrice_ForLuxuryType(double basePrice, double amount)
		{
			var calculator = new SellerFeeCalculator();

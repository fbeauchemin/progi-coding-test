...
public class AssociationFeeCalculatorTests
{
	public class CalculateMethod
	{
		...
		[InlineData(412)]
		[InlineData(500)]
		public void Returns_Amount_Of_5_WhenBasePriceIsBetween_1_and_500(double basePrice)
		{
		...
		[InlineData(834)]
		[InlineData(1000)]
		public void Returns_Amount_Of_10_WhenBasePriceIsGreaterThan_500_Up_To_1000(double basePrice)
		{
			var calculator = new AssociationFeeCalculator();
		...
		[InlineData(2587)]
		[InlineData(3000)]
		public void Returns_Amount_Of_15_WhenBasePriceIsGreaterThan_1000_Up_To_3000(double basePrice)
		{
			var calculator = new AssociationFeeCalculator();
		...
		[InlineData(7887)]
		[InlineData(1324300)]
		public void Returns_Amount_Of_30_WhenBasePriceIsOver_3000(double basePrice)
		{
			var calculator = new AssociationFeeCalculator();
